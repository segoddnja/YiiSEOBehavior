...
<div class="row">
    ...
    <?php echo CHtml::textArea('SeoData[keywords]', $model->seoData->title, array('cols'=>60, 'rows'=>'1')); ?>
</div>

<div class="row">
    <?php echo CHtml::label('Page meta description', null); ?>
    <?php echo CHtml::textArea('SeoData[description]', $model->seoData->title, array('cols'=>60, 'rows'=>'1')); ?>
</div>